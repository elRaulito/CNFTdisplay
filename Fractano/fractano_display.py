...
#what is the address?
owner="addr1q940uzrvvj23e0dgwmw8q0zpvvczuramhwpkl02tnzjpznlu2wfp0qyarklnvxgupjxnswuajcpagnd00uku2dt7ctls4wg8jj"
...
def get_Awoken(address):
    ...
    try:
        for nft in total:#line changed
            print(nft)
            if "lovelace" not in nft['unit'] and "623e64fa1dbe49fcda34b6133199eef48912b14a98e7aa29b8792fcf" in nft['unit']:
                counter=counter+1
                if counter>limit:
                    continue
